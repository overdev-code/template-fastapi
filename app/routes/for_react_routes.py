...
for_react_router = APIRouter(prefix="/react", tags=["users"], include_in_schema=False)
userController = UserController()

@for_react_router.post("/create")
...
@for_react_router.get("/read/{user_id}")
...
@for_react_router.put("/update/{user_id}")
...
@for_react_router.delete("/delete/{user_id}")
